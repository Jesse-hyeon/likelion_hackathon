...
import { Product, Auction, Bid } from '@/types';
...
export default function EnhancedBuyerDashboard() {
  ...
  const [gradeStats, setGradeStats] = useState<{ [key: string]: number }>({});
  ...
  const calculateGradeStats = (auctionsData: AuctionWithProduct[]) => {
