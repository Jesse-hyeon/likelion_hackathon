                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800">
                        배송 ID: {delivery.id.slice(0, 8)}
                      </h3>
                      <p className="text-sm text-gray-600">
                        상품 ID: {delivery.productId.slice(0, 8)}
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      위도: {delivery.currentLocation.lat.toFixed(4)}
                      <br />
                      경도: {delivery.currentLocation.lng.toFixed(4)}
                    </div>
                    <div className="flex items-center text-sm text-gray-600">
                  ...
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    예상 도착: {new Date(delivery.estimatedArrival).toLocaleString('ko-KR')}
                  </div>
