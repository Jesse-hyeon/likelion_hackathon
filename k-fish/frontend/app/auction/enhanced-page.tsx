...
import { Auction, Product, QualityAssessment } from '@/types';
import { 
...
export default function EnhancedAuctionPage() {
  ...
  const [auctionsWithProducts, setAuctionsWithProducts] = useState<AuctionWithProduct[]>([]);
  ...
  const grades: Array<QualityAssessment['overallGrade'] | 'all'> = ['all', 'A+', 'A', 'B+', 'B', 'C', 'D'];
                    ...
                    className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${
                      gradeFilter === grade
                        ? grade === 'all' 
                          ...
                          : `${getGradeColor(grade as QualityAssessment['overallGrade'])} text-white`
