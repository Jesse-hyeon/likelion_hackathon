...
export default function RegisterProduct() {
  ...
  const [formData, setFormData] = useState({
    ...
    weight,
    quantity,
    catchDateTime).toISOString().slice(0, 16),
    catchLocation, lng},
    startPrice,
    auctionLocation,
  });
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, species})}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, weight})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, quantity})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, catchDateTime})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, startPrice})}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setFormData({ ...formData, auctionLocation})}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                    >
